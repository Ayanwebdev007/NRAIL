...
import heroImg from '../assets/premium-board-hero.png';
import fbb1 from '../assets/fbb pic 1.jpg';
import fbb2 from '../assets/fbb pic 2.jpg';
import fbb3 from '../assets/fbb pic 3.jpg';
...
const NRPowerSection = () => {
    ...
    return (
        <section className="relative w-full h-[600px] flex items-center overflow-hidden group">
            ...
            {/* Content Overlay */}
            <div className="w-full h-full flex items-end justify-start relative z-10 pointer-events-none" style={{ paddingBottom: '60px', paddingLeft: '60px' }}>
                <motion.div
                    initial={{ opacity: 0, x: -80 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 1, ease: "easeOut" }}
                    className="max-w-xl rounded-none border border-white/10 pointer-events-auto"
                    style={{
                ...
                >
                    <h2 className="font-['Outfit'] font-thin text-white tracking-wide" style={{ fontSize: '28px', margin: 0, padding: 0, lineHeight: '1.2', color: 'white', fontWeight: 100 }}>
...
const NRPearlSection = () => {
    ...
    return (
        <section className="relative w-full h-[600px] flex items-center overflow-hidden group">
            ...
            <div className="absolute right-[60px] bottom-[60px] z-50 pointer-events-none w-[90%] md:w-auto">
                <motion.div
                ...
                >
                    <h2 className="font-['Outfit'] font-thin text-white tracking-wide text-right" style={{ fontSize: '28px', margin: 0, padding: 0, lineHeight: '1.2', color: 'white', fontWeight: 100 }}>
...
const IndustriesSection = () => {
    ...
    const industries = [
        { name: "Beauty and Personal Care", img: beautyImg },
        { name: "Food and Beverage", img: foodImg },
        { name: "Apparels", img: apparelImg },
        { name: "Pharmaceuticals", img: fbb3 },
        { name: "Electronics", img: fbb2 }
    ];
